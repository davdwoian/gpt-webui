...
exports.chatCompleteStream = exports.chatComplete = exports.OpenAIChatModelCost = exports.getSessionMessage = void 0;
...
const setSessionMessage = (sessionId, sysMsg) => {
    sessions.set(sessionId, [{ role: "system", content: sysMsg }]);
};
const getSessionMessage = (sessionId) => {
    if (!sessions.has(sessionId))
        setSessionMessage(sessionId, DEFAULT_SYS_MSG);
    return sessions.get(sessionId);
};
exports.getSessionMessage = getSessionMessage;
...
function chatComplete(model, prompt, sessionId, otherOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        let messages = (0, exports.getSessionMessage)(sessionId);
